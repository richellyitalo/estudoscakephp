...
class AnunciosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'vencimento' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'plan_tipo' => 1,
            'status' => 1,
            'vencimento' => '2016-02-11 15:11:59',
            'created' => '2016-02-11 15:11:59',
            'modified' => '2016-02-11 15:11:59'
        ],
    ];
}
