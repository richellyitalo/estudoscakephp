...
class PropertiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'anuncio_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'anuncio_id' => 1,
            'user_id' => 1,
            'created' => '2016-02-11 16:49:00',
            'modified' => '2016-02-11 16:49:00'
        ],
    ];
}
