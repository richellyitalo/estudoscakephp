...
class AnunciosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'plan_periodo' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'plan_tipo' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'plan_tipo' => 1,
            'status' => 1,
            'vencimento' => '2016-02-11 16:50:43',
            'created' => '2016-02-11 16:50:43',
            'modified' => '2016-02-11 16:50:43'
        ],
    ];
}
